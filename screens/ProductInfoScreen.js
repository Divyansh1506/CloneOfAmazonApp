  ...
  return (
    <ScrollView style={{ marginTop: 20, flex: 1, backgroundColor: "white" }} showsVerticalScrollIndicator={false}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false}>
        {route.params.carouselImages.map((item, index) => (
          <ImageBackground style={{ width, height, marginTop: 25, resizeMode: "contain" }} source={{ uri: item }} key={index}>
            ...
            <View style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: "#E0E0E0", justifyContent: "center", alignItems: "center", flexDirection: "row", marginLeft: 20, marginTop: "auto", marginBottom: 20 }}>
      ...
      <View style={{ padding: 10 }}>
        ...
        <Text style={{ color: "#00CED1" }}>FREE Delivery Tomorrow by 4 PM. Order within 10hrs 30 mins</Text>
      </View>

      <View style={{ flexDirection: 'row', marginVertical: 5, alignItems: 'center', gap: 5 }}>
        <Ionicons name="location" size={24} color="black" />
        <Text style={{ fontSize: 15, fontWeight: "500" }}>Deliver to Divyansh - Bhopal 462024</Text>
      </View>
