      ...
      <SafeAreaView style={{
        ...
        <ScrollView>
          ...
          <Pressable onPress={() => setModalVisible(!modalVisible)} style={{ flexDirection: 'row', alignItems: 'center', gap: 5, padding: 10, backgroundColor: "#AFEEEE" }}>
            ...
            <Pressable onPress={() => setModalVisible(!modalVisible)}>
              <Text style={{ fontSize: 13, fontWeight: 500 }}>
                Deliver to Divyansh - Pipariya 461775
              </Text>
            </Pressable>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {list.map((item, index) => (
              <Pressable key={index} style={{ margin: 12, justifyContent: 'center', alignItems: 'center' }}>
          ...
          {/* 
        <SliderBox
          images ={images} autoPlay circleLoop dotColor={"#13274f"} inactiveDotColor="#90A4AE" ImageComponentStyle={{width:"100%"}}
        /> */}
            ...
            {offers.map((item, index) => (
              <Pressable onPress={() =>
                ...
                <View style={{ backgroundColor: "#E31837", paddingVertical: 5, width: 130, justifyContent: 'center', alignItems: 'center', marginTop: 10, borderRadius: 4 }}>
                  ...
                  <Text style={{ textAlign: 'center', color: "white", fontSize: 13, fontWeight: 600 }}>Upto {item?.offer}</Text>
          ...
          <View style={{ marginHorizontal: 10, width: "45%", marginBottom: open ? 50 : 15, }}>
            <DropDownPicker style={{ marginTop: 20, borderColor: "#B7B7B7", height: 30, marginBottom: open ? 120 : 15, }}
        ...
        <ModalContent style={{ width: "100%", height: 400 }}>
          ...
          <View style={{flexDirection:'column',gap:7,marginBottom:30}}>
            <View
              ...
              <Text style={{ color: "#0066b2", fontWeight: '400' }}>Enter a Pincode</Text>
            </View>
            <View
              style={{ flexDirection: "row", alignItems: 'center', gap: 5 }}>
